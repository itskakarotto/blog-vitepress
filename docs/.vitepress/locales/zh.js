...
import postsSidebarData from '../postsSidebarData.json' assert { type: 'json' }
import vitepressSidebarData from '../vitepressSidebarData.json' assert { type: 'json' }
import exampleSidebarData from '../exampleSidebarData.json' assert { type: 'json' }
export default {
    // 导航栏
    nav: [
        { text: '首页', link: '/' },
